...
> הדמוגרפיה, המועמדים בהליך, זמני הנסיעה ו-11,538 שורות המשרה — כולם מהתפלגות
...
| **מפת חום מנהלה** | תקנים פנויים לגיוס ברמת המשרה הבודדת: מספר משרה, היקף, תיאור עיסוק, סיווג, דרגה ורמות ההיררכיה. סינון לפי תפקיד, אזור, אגף ויחידה. |
...
| **הגדרות** | שלוש לשוניות: ניהול נתונים (7 מערכי נתונים), ספי צבע ומרחק, וטעינת אקסלים עם Data Guard. |
...
התשובות הוא הקוד האמיתי — ועדכון הדמו הוא שתי הרצות והעתקת שלושה קבצים.
